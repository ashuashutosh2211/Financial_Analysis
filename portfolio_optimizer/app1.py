...
from . import shortselling
from . import no_short_selling
def main():
    ...
    df = pd.read_csv(r'C:\Users\91860\OneDrive\Desktop\Financial_Analysis\Financial_Analysis\portfolio_optimizer\yahootickers2.csv')
